...
function addTask(evt) {
    evt.preventDefault()
    // const taskInput = evt.target.querySelector("#taskText");
...
function ToggleTaskComplete(evt) {
    ...
    const parentli = doneBtn.closet('li');
    parentli.dataset.completed = !parentli.completed
